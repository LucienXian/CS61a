...
def make_to_string(front, mid, back, empty_repr):
    ...
    def helper(lst):
        ...
        return str(front) + str(lst.first) + str(mid) + helper(lst.rest) + str(back)
    return helper
...
def add_trees(t1, t2):
    ...
    return Tree(new_root, [add_trees(t1_br, t2_br) for t1_br, t2_br in zip(t1_branches, t2_branches)])
