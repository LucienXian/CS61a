...
def quadratic(x, a, b, c):
    ...
    if a > 0:
        if low < ext < up:
            return interval(quadratic(ext), max(quadratic(up), quadratic(low)))
        else:
            return interval(quadratic(low), quadratic(up))
    else:
        if low < ext < up:
            return interval(quadratic(ext), min(quadratic(up), quadratic(low)))
        else:
            return interval(quadratic(low), quadratic(up))
